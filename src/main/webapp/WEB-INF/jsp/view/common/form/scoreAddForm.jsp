...
<div id="score_add_layer" class="w3-modal">
	<div class="w3-modal-content w3-card-8 w3-animate-zoom"
		...
		<form class="w3-container" id="score_addForm" action="/score/add">
			<div class="w3-section">
				<label><b>StudentId</b></label> 
				<input class="w3-input w3-border w3-margin-bottom" type="text"
					placeholder="Enter StudentId ex)12345678" name="studentId" id="studentId"> 
				<label><b>SubjectId</b></label>
				<input class="w3-input w3-border w3-margin-bottom" type="text"
					placeholder="Enter SubjectId ex)12345" name="subjectId" id="subjectid">
				<label><b>Score</b></label> 
				<input class="w3-input w3-border w3-margin-bottom" type="text"
					placeholder="Enter Score" name="grade" id="grade">
