		...
		<form class="w3-container" id="score_modifyForm"
			...
			<div class="w3-section">
				<input class="w3-input w3-border w3-margin-bottom" type="hidden"
					placeholder="Enter StudentId" name="studentId" id="studentId">
				<input class="w3-input w3-border w3-margin-bottom" type="hidden"
					placeholder="Enter SubjectId" name="subjectId" id="subjectId"> 
				<label><b>Score</b></label> 
				<input class="w3-input w3-border w3-margin-bottom" type="text"
					placeholder="Enter Score" name="grade" id="score">
