...
<div id="modify_staff_form" class="w3-modal">
	<div class="w3-modal-content w3-card-8 w3-animate-zoom"
		style="max-width: 600px">
		<div class="w3-center">
			<br> <span
				onclick="document.getElementById('modify_staff_form').style.display='none'"
		...
		<form class="w3-container" id="staff_modifyForm"
			action="/staff/modify">
			<div class="w3-section">
				<label><b>Name</b></label> <input type="hidden" name="id">
