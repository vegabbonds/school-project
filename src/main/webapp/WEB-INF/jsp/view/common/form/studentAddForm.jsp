...
<div id="student_add_layer" class="w3-modal">
	<div class="w3-modal-content w3-card-8 w3-animate-zoom"
		...
		<form class="w3-container" id="student_addForm" action="/student/add">
			<div class="w3-section">
				<label><b>StudentId</b></label> 
				<input class="w3-input w3-border w3-margin-bottom" type="text"
					placeholder="Enter StudentId ex)12345678" name="id" id="id">
				<label><b>Name</b></label> 
				<input class="w3-input w3-border w3-margin-bottom" type="text"
					placeholder="Enter Name" id="name" name="name"> 
				<label><b>BirthDate</b></label>
				<input class="w3-input w3-border w3-margin-bottom" type="date"
					placeholder="Enter BirthDate ex)1990-03-02" id="birth" name="birth">
