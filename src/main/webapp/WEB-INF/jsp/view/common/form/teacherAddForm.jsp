...
<div id="teacher_add_layer" class="w3-modal">
	<div class="w3-modal-content w3-card-8 w3-animate-zoom"
		style="max-width: 600px">
		<div class="w3-center">
			<br> <span
				onclick="document.getElementById('teacher_add_layer').style.display='none'"
		...
		<form class="w3-container" id="teacher_addForm"
			action="/teacher/add">
			<div class="w3-section">
				<label><b>TeacherId</b></label> 
				<input class="w3-input w3-border w3-margin-bottom" type="text"
					placeholder="Enter TeacherId ex)123456" name="id" id="id"> 
				<label><b>Name</b></label>
				<input class="w3-input w3-border w3-margin-bottom" type="text"
					placeholder="Enter Name" name="name" id="name"> 
				<label><b>BirthDate</b></label>
				<input class="w3-input w3-border w3-margin-bottom" type="date"
					placeholder="Enter BirthDate ex)1990-03-02" name="birth" id="birth">
				<label><b>SubjectId</b></label> 
				<input class="w3-input w3-border w3-margin-bottom" type="text"
